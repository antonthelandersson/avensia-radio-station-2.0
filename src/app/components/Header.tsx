...
export default function Header() {
    return (
        <nav style={{ backgroundColor: '#092137', height: 85, width: '100vw'}} className=" flex w-full justify-center py-4 items-center 
        border-b border-gray-300  backdrop-blur-2xl font-mono text-sm px-4 lg:px-0">
            <div className="max-w-3xl flex w-full items-center justify-between">
                <div style={{ display: 'flex', alignContent: 'center', justifyContent: 'center', flexDirection: 'column', width: '100%'}} className="font-medium text-xl text-indigo-900 flex items-center gap-2">
